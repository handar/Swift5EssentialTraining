...
*/
// Type inference
var currentHealth = 90 //var assumes currentHealth is an int

// Type annotation
//varaibles won't always be declared with initial values, so this means you have to explicitly declare its type
var characterName: String //assigns it a type
characterName = "King Krull"

// Type annotation + inference
var maxHealth: Int = 100 //overkill haha

// Multiple variables - type annotation shorthand
var inventoryItems, equipmentSlots, currentGold: Int //declare all 3 as int 
